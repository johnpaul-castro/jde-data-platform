...
FROM {{ ref('silver_sales_order_header') }} h
JOIN {{ ref('silver_sales_order_detail') }} d ON h.order_id = d.order_id
LEFT JOIN {{ ref('silver_address_book') }} a ON h.sold_to_id = a.address_id
